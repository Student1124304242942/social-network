...
const UserCart = ({ userName, userSkills, userAvatar, id }: UserCartProps) => {
  ...
  return (
    <div key={id} className="p-4 sm:p-6 bg-gray-100 rounded-lg shadow-md">
      <Link href={`users/${id}`} className="flex flex-col md:flex-row items-center justify-between p-2 sm:p-4 bg-white rounded-lg shadow hover:shadow-lg transition-shadow min-w-full">
